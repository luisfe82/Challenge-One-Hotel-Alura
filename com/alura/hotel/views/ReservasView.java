...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFormaPago.setModel(new DefaultComboBoxModel<String>(
				new String[] { null,"Tarjeta de Crédito", "Tarjeta de Débito", "Dinero en efectivo" }));
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int resp = JOptionPane.showConfirmDialog(null, "¿Esta seguro?,se cancelara la reservación", "Alerta!", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE);
				if(resp == 0) {
